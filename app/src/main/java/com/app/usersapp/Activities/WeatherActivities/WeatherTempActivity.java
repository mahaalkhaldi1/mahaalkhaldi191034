...
public class WeatherTempActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather_temp);
    ...
    private void getTemperature() {
        value.setText(String.valueOf(Math.round(sharedPreferences.getFloat("temp",0.0f))));
    }
}
