...
public class WeatherCloudsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather_clouds);
    ...
    void getClouds(){
        value.setText(String.valueOf(Math.round(sharedPreferences.getFloat("clouds",0.0f))));
    }
}
